...
This has the downside of doubling the memory requirements of connections when STDP is required -- the reason that the model described in this section only runs on Tesla GPUs with larger amounts of memory.
Additionally \citet{Yavuz2016} showed that the non-coalesced accesses to the synaptic matrix this approach results in leads to poor performance on lower-end GPUs.
