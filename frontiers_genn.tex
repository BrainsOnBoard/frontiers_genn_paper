...
While using MPI would eventually result in simulations become communication bound , NVIDIA's GPUDirect~\citep{NVIDIACorporation2018c} technology allows data to be transferred directly between GPUs via compatible network cards rather than having to go via the host computers main memory.
