...
In this paper we introduce novel methods for parallel initialisation of SNNs in the GeNN simulator and investigate the performance of a GPU based simulation of the micro-column network model \cite{Potjans2012,VanAlbada2018} using GeNN as well as a model using STDP in a highly connected network~\citep{Morrison2007}.
