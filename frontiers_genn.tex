...
\usepackage{booktabs,url,hyperref,lineno,listings,microtype,subcaption}
...
\todo{how many top 500 supecomputers have NVIDIA?}
...
%
While this approach allows a lot of flexibility and means that visualisation tools and closed-loop robotics can be tightly coupled to GeNN simulations, combined with the use of C++ for model definition, this 
...
To assess the performance of our GeNN simulations we chose a selection of GPUs across the spec

\begin{table}
  \centering
  \begin{tabular}{r r S r S S}
    \toprule
        {Device model}  & {Target market}   & {Thermal Design Power}    & {Architecture}    & {Number of}   & {Memory} \\
                        &                   & {TDP [\si{\watt}]}        &                   & {CUDA cores}  & {[\si{\giga\byte}]} \\
    \midrule
        GeForce 1050 Ti & Gaming            & 75                        & Pascal            & 768           & 4 \\
        Jetson TX2      & Embedded          & 15                        & Pascal            & 256           & 4* \\
        Tesla K40m      & HPC               & 245                       & Kepler            & 2880          & 12 \\
        Tesla V100      & HPC               & 250                       & Volta             & 5120          & 16 \\
    \bottomrule
  \end{tabular}
