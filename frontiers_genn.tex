...
In this paper we use our GeNN code generator to re-implement two large-scale point SNNs with levels of connectivity and sparseness matching those in the neocortex and discuss how they are mapped to GPU hardware.
