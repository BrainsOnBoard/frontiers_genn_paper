...
These `half precision' floating point numbers \todo{say why they're great}
...
While, communication overheads would , NVIDIA's GPUDirect~\todo{cite} technology allows data to be transferred directly between GPUs via compatible network cards rather than having to go via the host computers main memory.
