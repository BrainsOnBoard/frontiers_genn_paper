...
\todo{make coherant}
Additionally, while a lack of global synchronisation is indeed biomimetic and makes very large-scale distributed systems like SpiNNaker possible, it makes traditional debugging techniques impossible a
\todo{FPGA}
...
In this paper we investigate the performance of a GPU based simulation of the same network model as well as a model using STDP in a highly connected network~\citep{Morrison2007} to competitively benchmark a GPU based solution for SNN simulations.
