...
\begin{figure}
    \begin{center}
        \includegraphics[width=180mm]{figures/ragged_matrix}
    \end{center}
    \caption{GPU parallelism of sparse synaptic matrix processing.
...
However, on modern GPU hardware, this can also be implemented in an efficient manner using the data structure shown in figure~\ref{fig:ragged_matrix}.
