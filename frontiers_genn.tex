...
Besides performance in terms of speed and energy consumption for the actual simulation, it has recenty been found that efficient initialisation of simulations can be crucial for the utility of different hardware substrates.
