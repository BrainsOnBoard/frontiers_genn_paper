...
Therefore we believe that using GeNN to develop SNN-based controllers to run on embedded GPUs such as the Jetson TX2 is a very competitive approach for neuro robots.
For example, the Brains on Board project~(\url{www.brainsonboard.co.uk}) is using Jetson TX1 and TX2 GPUs to build autonomous flying robots with navigational and learning abilities inspired by honeybees.
