...
In a recent publication van Albada et al. \cite{vanAlbada2018} investigated the comparative performance of simulations of a micro-column model\citep{Potjans2012} in NEST-based simulations on an HPC cluster and when implemented on the SpiNNaker neuromorphic system.
...
At this speed SPiNNaker and NEST and SpiNNaker consumed about the same energy 6$\mu$J per simulated synaptic event.
