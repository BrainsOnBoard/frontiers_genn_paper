...
GeNN allows the development of SNN-based controllers that run on embedded GPUs such as the Jetson TX2 allowing to control mobile robots of comparably small form factors with simulated brain circuits.
