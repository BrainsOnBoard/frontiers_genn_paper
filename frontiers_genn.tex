...
Because, in this paper we use NVIDIA hardware and because each manufacturer (confusingly) use their own terminology, for clarity we will refer to concepts using NVIDIA's terminology.
...
Similarily, we will talk about SIMT programming in the context of CUDA because this is what GeNN is implemented in, but OpenCL~\citep{Stone2010} is conceptually similar.
